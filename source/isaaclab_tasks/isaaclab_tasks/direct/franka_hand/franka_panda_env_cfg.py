...
from isaaclab_assets.robots.frankahand import FRANKA_HAND_CFG,FRANKANOHAND_PANDA_CFG,FRANKANOHAND_PANDA_HIGH_PD_CFG
...
@configclass
class FrankaPandaEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 2
    episode_length_s = 20.0
    action_space = 7
    observation_space = 92# (full)
    state_space = 0
    ...
    # )
    # scene
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=8192*4, env_spacing=2, replicate_physics=True)
...
@configclass
class FrankaHandOpenAIEnvCfg(FrankaPandaEnvCfg):
    # env
    decimation = 3
